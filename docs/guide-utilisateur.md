...
C4DENCE est votre plateforme d'exécution stratégique basée sur la méthodologie **4DX** (The 4 Disciplines of Execution). Elle vous aide à transformer vos objectifs ambitieux en résultats concrets grâce à un système éprouvé de focus, de mesure et de responsabilisation.

### Ce que C4DENCE vous permet de faire

- **Définir** vos objectifs les plus importants (WIGs)
- **Mesurer** les actions qui mènent au succès
- **Visualiser** votre progression en temps réel
- **Maintenir** une cadence d'exécution avec votre équipe

### Connexion

C4DENCE utilise la connexion sécurisée via Google. Cliquez simplement sur **"Continuer avec Google"** et utilisez votre compte professionnel.

![Page de connexion](images/01-login-desktop.png)
...
![Création d'organisation](images/22-onboarding-desktop.png)
...
![Page des membres](images/17-members-desktop.png)
...
- **Statut WINNING/LOSING** — Êtes-vous en train de gagner?
- **Vos WIGs actifs** — Les objectifs en cours
- **Vos engagements** — Ce que vous avez promis cette semaine

![Tableau de bord](images/02-dashboard-desktop.png)
...
Un **WIG** (Wildly Important Goal) est un objectif tellement important que si vous ne l'atteignez pas, rien d'autre n'a vraiment d'importance. Ce n'est pas un objectif ordinaire — c'est L'OBJECTIF qui change la donne.

#### Comment créer un bon WIG

Un WIG efficace suit le format **"De X à Y d'ici [date]"** :
...
#### Créer un WIG dans C4DENCE

1. Depuis le tableau de bord, cliquez sur **+ Nouveau WIG**
...
7. Assignez un **responsable**

#### Pourquoi se limiter à 2-3 WIGs
...
- 2-3 WIGs → 100% de chances d'excellence
- 4-10 WIGs → 1-2 atteints avec excellence
- 11+ WIGs → Aucun atteint avec excellence

C4DENCE vous encourage à **faire moins, mais mieux**.

---

### Discipline 2 : Mesures prédictives (Lead Measures)

#### Lead vs Lag : la différence qui change tout

| Type | Définition | Exemple | Quand on le sait |
|------|------------|---------|------------------|
| **Lag Measure** | Le résultat final | Ventes mensuelles | Après coup |
| **Lead Measure** | L'action qui influence le résultat | Appels de prospection | En temps réel |

Votre WIG est un **Lag Measure** — vous ne pouvez pas le changer directement.

Les **Lead Measures** sont les actions que vous contrôlez et qui **prédisent** le résultat.

#### Créer une mesure prédictive

1. Ouvrez un WIG existant
2. Dans la section **Mesures prédictives**, cliquez sur **+ Ajouter**
3. Nommez votre mesure (ex: "Appels de prospection")
...
Chaque semaine, mettez à jour vos Lead Measures :

1. Depuis la liste WIGs ou le détail du WIG
...
![Liste des WIGs](images/05-wigs-list-desktop.png)

---

### Discipline 3 : Le Scoreboard

Le scoreboard est le coeur visuel de votre exécution. Il répond à une question simple : **"Est-ce qu'on gagne?"**
...
- **WINNING** 🏆 — La majorité de vos WIGs sont en bonne voie
- **LOSING** — Vous avez du travail à faire

**Si vous êtes en LOSING** :
1. Ne paniquez pas — c'est une information, pas une condamnation
2. Identifiez quel WIG est en difficulté
3. Analysez les Lead Measures — quelles actions sont en retard?
4. Discutez-en en réunion de cadence
...
La cadence est le rythme régulier qui transforme la stratégie en habitude. Sans cadence, même le meilleur plan échoue.
...
2. **Revoir le scoreboard** — Où en sommes-nous?
3. **Prendre des engagements** — Que ferez-vous cette semaine?

![Page Cadence](images/12-cadence-page-desktop.png)
...
2. Le timer compte le temps écoulé
...
- **Impactant** : Il fait avancer le WIG
...
![Page Paramètres](images/18-settings-desktop.png)
...
- Seul un administrateur peut supprimer définitivement un WIG

### "Qui peut voir mes données?"

Tous les membres de votre organisation peuvent voir :
- Les WIGs et leur progression
- Les Lead Measures et scores
...
1. **Analysez** — Quelles Lead Measures sont en retard?
2. **Discutez** — En cadence, identifiez les obstacles
...
- **Livre** : *"The 4 Disciplines of Execution"* par Chris McChesney, Sean Covey, Jim Huling
- **Vidéos** : Chaîne YouTube FranklinCovey
...
### Tablette
![Vue tablette](images/02-dashboard-tablet.png)

### Mobile
![Vue mobile](images/02-dashboard-mobile.png)
